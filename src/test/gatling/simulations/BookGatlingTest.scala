...
class BookGatlingTest extends Simulation {
    ...
    val scn = scenario("Test the Book entity")
        ...
        .repeat(2) {
            ...
            .put("/api/books")
            .headers(headers_http_authenticated)
            .body(StringBody("""{"id":null, "title":"SAMPLE_TEXT", "author":"SAMPLE_TEXT", "description":"SAMPLE_TEXT", "publisher":"SAMPLE_TEXT", "available":null, "created":"2020-01-01T00:00:00.000Z", "updated":"2020-01-01T00:00:00.000Z"}""")).asJSON
            .check(status.is(201))
